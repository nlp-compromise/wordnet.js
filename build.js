...
do_pos = function(pos, cb) {
  ...
  return freebase.paginate([q], {
    ...
    fs.writeFileSync("./" + (pos.toLowerCase()) + ".js", "exports.data= " + (JSON.stringify(all, null, 2)));
    return cb(all);
  });
};
...
do_pos("Adverb", function(r) {
  ...
  return do_pos("Adjective", function(r) {
    console.log(r.length + " adjectives");
    return do_pos("Verb", function(r) {
      console.log(r.length + " verbs");
      return do_pos("Noun", function(r) {
        return console.log(r.length + " nouns");
      });
    });
  });
});